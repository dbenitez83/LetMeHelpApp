from key import key
from get_data import risk_binning, pop_density_binning
...
class Map(object):
    ...
    def __str__(self):
        ...
        # API key
        html = html.replace('AIzaSyDxydKN7Yt54JNmVw9opg9EcibCghjetgw', key)

        # Labels and colors for default relative median risk visualizion
        labels, colors = risk_binning(return_colors=True)
